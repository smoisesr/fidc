...
public class MaioresCedentesAttempt 
{
	ArrayList<Entidade> cedentes = new ArrayList<Entidade>();
	...
	public ArrayList<Entidade> getCedentes() {
		return cedentes;
	}

	public void setCedentes(ArrayList<Entidade> cedentes) {
