...
public class ConcentracaoCedenteIndicador 
{
...
//	DataAtualizacao
	...
	public ConcentracaoCedenteIndicador() 
	{
		
	}
	
	public ConcentracaoCedenteIndicador(Entidade cedente, FundoDeInvestimento fundo, double valorFinanceiro, double valorPercentual, double valorDisponivelFinanceiro)
	{
	...
	public ConcentracaoCedenteIndicador(Entidade cedente, FundoDeInvestimento fundo, Date dataEstoque, Connection conn)
	{	
		this.cedente = cedente;
		this.fundo = fundo;
		Statement stmt = null;
