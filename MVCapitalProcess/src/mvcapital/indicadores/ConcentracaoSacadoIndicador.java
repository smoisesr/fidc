...
public class ConcentracaoSacadoIndicador 
{
...
//	DataAtualizacao
	...
	public ConcentracaoSacadoIndicador() 
	{
		
	}
	
	public ConcentracaoSacadoIndicador(Entidade sacado, FundoDeInvestimento fundo, double valorFinanceiro, double valorPercentual, double valorDisponivelFinanceiro)
	{
		this.sacado=sacado;
		this.fundo=fundo;
	...
	public ConcentracaoSacadoIndicador(Entidade sacado, FundoDeInvestimento fundo, Date dataEstoque, Connection conn)
	{	
		this.sacado = sacado;
		this.fundo = fundo;
		Statement stmt = null;
