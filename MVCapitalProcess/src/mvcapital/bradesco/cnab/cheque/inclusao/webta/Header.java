...
//		this.identificacaoDoRegistro.setConteudo("0");
		...
		this.codigoDeServico = new Campo(7,78,82,5,true,Register.campoAlfaNumerico,0,"COMPE");
		this.codigoDeEmpresa = new Campo(8,83,90,8,true,Register.campoNumerico,0,"");
