...
//		this.identificacaoDoRegistro.setConteudo("0");
		...
		this.codigoDeEmpresa = new Campo(7,41,48,8,true,Register.campoAlfaNumerico,0,"");
		this.espacos = new Campo(8,49,80,32,true,Register.campoNumerico,0,"");
		this.sequenciaInterna = new Campo(9,81,90,10,true,Register.campoNumerico,0,"");
		this.numeroSequencialRegistro = new Campo(10,91,100,10,true,Register.campoNumerico,0,"");
	}
