...
//		this.identificacaoDoRegistro.setConteudo("0");
		...
		this.espacos = new Campo(6,69,80,12,true,Register.campoAlfaNumerico,0,"");
		this.sequenciaInterna = new Campo(7,81,90,10,true,Register.campoNumerico,0,"");
		this.numeroSequencialRegistro = new Campo(8,91,100,10,true,Register.campoNumerico,0,"");
	}
