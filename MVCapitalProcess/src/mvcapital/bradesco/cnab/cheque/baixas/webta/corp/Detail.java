...
public class Detail extends Register
{
	...
	private Campo cpf = new Campo();
	private Campo bordero = new Campo();
	private Campo filialCnpj = new Campo();
...
//		private String conteudo="";		
		this.identificacaoRegistro.setConteudo("1");
		...
		this.c2 = new Campo(4,11,11,1,true,Register.campoNumerico,0,"");
		this.contaCorrente = new Campo(5,12,23,12,true,Register.campoNumerico,0,"");
		...
		this.c3 = new Campo(8,31,31,1,true,Register.campoNumerico,0,"");
		this.uf = new Campo(9,32,33,2,true,Register.campoNumerico,0,"");
		this.valor = new Campo(10,34,50,17,true,Register.campoNumerico,0,"");
		this.tipoDeCheque = new Campo(11,51,51,1,true,Register.campoNumerico,0,"");
		this.td = new Campo(12,52,53,2,true,Register.campoNumerico,0,"");
		this.espacos = new Campo(13,54,55,2,true,Register.campoNumerico,0,"");
		...
		this.compensacaoAcol = new Campo(18,79,81,3,true,Register.campoNumerico,0,"");
		this.dataDeMovimento = new Campo(19,82,89,8,true,Register.campoNumerico,0,"");
		...
		this.cpf = new Campo(22,100,110,11,true,Register.campoNumerico,0,"");
		this.bordero = new Campo(23,111,115,5,true,Register.campoNumerico,0,"");
		this.filialCnpj = new Campo(24,116,119,4,true,Register.campoNumerico,0,"");
		this.campoExclusivoDoCliente = new Campo(25,120,144,25,true,Register.campoNumerico,0,"");
		this.espacos2 = new Campo(26,145,150,6,true,Register.campoNumerico,0,"");
		this.numeroSequencialRegistro = new Campo(27,151,160,10,true,Register.campoNumerico,0,"");
	}
	...
	public void setCpf(Campo cpf)
	{
		this.cpf = cpf;
	}


	public Campo getBordero()
	{
		return bordero;
	}


	public void setBordero(Campo bordero)
	{
		this.bordero = bordero;
	}


	public Campo getFilialCnpj()
	{
		return filialCnpj;
	}


	public void setFilialCnpj(Campo filialCnpj)
	{
