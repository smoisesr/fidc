...
public class Detail extends Register
{
	...
	private Campo cnpj = new Campo();
	private Campo filial = new Campo();
	private Campo digitoCnpj = new Campo();
...
//		private String conteudo="";		
		...
		this.dataDoMovimento = new Campo(19,82,89,8,true,Register.campoNumerico,0,"");
		...
		this.cnpj = new Campo(22,100,108,9,true,Register.campoNumerico,0,"");
		this.filial = new Campo(23,109,112,4,true,Register.campoNumerico,0,"");
		this.digitoCnpj = new Campo(24,113,114,2,true,Register.campoNumerico,0,"");
		this.espacos2 = new Campo(25,115,150,36,true,Register.campoAlfaNumerico,0,"");
	...
	public Campo getCnpj()
	{
		return cnpj;
	}

	public void setCnpj(Campo cnpj)
	{
		this.cnpj = cnpj;
	}
	...
	public Campo getDigitoCnpj()
	{
		return digitoCnpj;
	}

	public void setDigitoCnpj(Campo digitoCnpj)
	{
