...
public class WorkingDays 
{
	...
	public static void main(String[] args)
	{
		...
		MySQLAccess mysql = new MySQLAccess("192.168.2.160", 3306, "robot", "auto@mvc123", "MVCapital");
		mysql.connect();	
...
//		}
		...
		for(int prazo:prazosUteis)
		{
			...
			System.out.println(sdfr.format(start) + "\t" + prazo + "\t" + prazoDiasCorridos+ "\t" + sdfr.format(afterWorkDays(start,prazo, conn)));
		}
	}
