...
public class OrganizeCaixaSocopa extends OrganizeCaixa
{
	public OrganizeCaixaSocopa(FundoDeInvestimento fundo, int idEntidadeServidor, Login login, Connection conn)	
	{
