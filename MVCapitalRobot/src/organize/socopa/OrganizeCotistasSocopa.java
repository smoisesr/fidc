...
public class OrganizeCotistasSocopa extends OrganizeCotistas
{
	public OrganizeCotistasSocopa(FundoDeInvestimento fundo, int idEntidadeServidor, Login login, Connection conn)	
	{
...
//		}
		...
		{
    		File destiny = new File(super.rootCotistasProcessar+separator+file.getName());
    		OperatingSystem.copyRecentFile(file, destiny);
    		try {
				OperatingSystem.delete(file);
			} catch (IOException e) {
