...
public class RowRendaFixa extends Row 
{
	protected String codigo="";
	protected Date dataDeAplicacao=null;
	...
	public RowRendaFixa(String line)
	{
	...
	public void showRow()
	{
		System.out.println("RF:\t" 
				+ this.codigo 
				+ "\t" + Report.formatterDateShort.format(this.dataDeAplicacao) 
				+ "\t" + this.emitente 
				+ "\t" + this.papel 
	...
	public void setAplicacao(Date aplicacao) {
		this.dataDeAplicacao = aplicacao;
	}
