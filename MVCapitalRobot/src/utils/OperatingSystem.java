...
{
	private static String rootLocalWindows="";
	private static String rootLocalLinux="";
...
//		System.out.println("RootLocalDir: " + rootLocalDir);
	...
	public static void extractFile(String source, String password, String destination)
	{
...
//	        	System.out.println(password);
	    ...
	    catch (ZipException e) 
	    {
	        ...
	        e.printStackTrace();
	        System.out.println("Trying with password UpCase");	        
	        try {
				zipFile.setPassword(password.toUpperCase());
	        ...
	        try {
		    	...
		    	System.out.println("\t\tExtraction Failed Again, check Password" + destination);	    	
				e1.printStackTrace();
			}
	    }	
	}
