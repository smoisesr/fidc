...
public class WriteDetailRetornoBradescoToCSV 
{
	public static void writeCsvFile(String outputFileAbsolutePath, ArrayList<RegisterDetailRetornoBradesco> details)
	  {
	     try
	     {
	         ...
	         for (RegisterDetailRetornoBradesco detail : details) 
	         {
