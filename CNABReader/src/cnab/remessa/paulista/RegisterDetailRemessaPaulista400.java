...
public class RegisterDetailRemessaPaulista400  extends Register
{
	...
	private RegisterField chaveDaNota = new RegisterField(395,395,"Chave da Nota Fiscal Eletronica","chaveDaNota"); //$NON-NLS-1$ //$NON-NLS-2$
	private RegisterField seqDoRegistro = new RegisterField(395,400,"Número sequencial do Registro","seqDoRegistro"); //$NON-NLS-1$ //$NON-NLS-2$

	public RegisterDetailRemessaPaulista400(String line)
	{
		...
		this.chaveDaNota.setValue(""); //$NON-NLS-1$
